...
class AgentLauncherTests(unittest.TestCase):
    ...
    def test_strategy_preparation_uses_bounded_timeout(self, _which) -> None:
        ...
        def runner(command, **kwargs):
            ...
            return subprocess.CompletedProcess(
                command, 0,
                '{"outcome":"finished","prepared_work_item_ids":["JOB-1"],"strategy_readiness":[{"work_item_id":"JOB-1","strategy_name":"TestStrategy","status":"ready","contract_checks":[{"code":"positive_quantity","status":"pass"},{"code":"exit_shape","status":"pass"},{"code":"indicator_api","status":"pass"},{"code":"callback_api","status":"pass"}]}]}',
                "",
            )
